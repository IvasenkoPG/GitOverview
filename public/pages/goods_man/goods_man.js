...
$.ajax({
    ...
    success: function (data) {
        var out = "";
        for (var key in data) {
            out += "<div class='man-clothes'>";
            out += '<img src = "' + data[key].img + '" alt="clothes">';
            out += "<h4>" + data[key].name + "</h4>";
            out += "<p>" + data[key].cost + " грн." + "</p>";
            out += "<button class='add-man' data-vincode ='" + key + "'>Перегляд</button>";
            out += "</div>";
        }
        $(".man").append(out);
        $('button.add-man').click(function () {
