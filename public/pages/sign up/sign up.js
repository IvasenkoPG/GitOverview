...
$("header").append("<div class='menu-top'><div class='container'><div class='row'><div class='col-md-12'><ul class='links-top'><li class='contact'><a href='../feedback/feedback.html'>Контакти</a></li><li class='log in'><a href='../log in/log in.html'>Вхід</a></li><li class='sign up'><a href='sign up.html'>Зареєструватися</a></li><li class='top-cart'><img class='img-cart' src='../../images/cart-icon.svg' alt='logo'><a href='../cart/cart.html'> Кошик <span> (0) </span></a><div class='add-cart'><div class='liner'><p class='empty'>Ваш кошик порожній</p></div> </div></li></ul><ul class='menu-header'><li class='head-left'><span>{</span><h3 class='classy'>CASUAL - як стиль життя</h3><span>}</span><ul><li><a href='../about/about.html'>Про нас</a></li><li><a href='../goods_man/goods_man.html'>Мужський</a></li><li><a href='../goods_womens/goods_womens.html'>Жіночій </a></li></ul></li><li class='logo'><a href='../../index.html'><img src='../../images/logo.png' alt='logo'></a><h4 class='name-logo'>ДЖИНСОВИЙ ОДЯГ</h4></li><li class='head-right'><span>{</span><h3 class='classy'>Бездоганна якість</h3><span>}</span><div class='search-box'><form class='search-form'><input class='search' type='text' placeholder='пошук товару'><button type='submit'>Пошук</button></form></li></ul></div></div></div></div>");

//Полоса страниц

$("body").append("<div class='menu-breadcrumbs'><div class='container'><div class='row'><div class='col-md-12'><ul class='breadcrumbs'><li class='home'><a href='../../index.html'>Головна</a><span class='gap'>/</span></li><li class='breadcrumbs-about'><em>Зареєструватися</em></li></ul></div></div></div></div>");
$(".menu-breadcrumbs").insertAfter("header");


//Контент для страницы  Регестрация

$(".content_main").append("<div class='sign_up-info-pages'><div class='container'><div class='row'><div class='col-md-12'><h3><strong>Створити аккаунт</strong></h3><form class='content-forms'><div class='content-form'><label><em>*</em>Ім'я</label><br><input type='text' name='firstname' value='' required><br><br><label><em>*</em>Призвище</label><br><input type='text' name='lastname' value='' required><br><br><label><em>*</em>Електрона адреса</label><br><input type='text' name='email' value='' required><br><br><label><em>*</em>Пароль</label><br><input type='password' name='password' value='' required><br><br><label><em>*</em>Підтвердити пароль</label><br><input type='password' name='password' value='' required><br><br><input class='button-login' type='submit'  value='Відправити'></div></form></div> </div></div><div>");
