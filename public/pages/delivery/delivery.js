...
$("body").append("<div class='menu-breadcrumbs'><div class='container'><div class='row'><div class='col-md-12'><ul class='breadcrumbs'><li class='home'><a href='../../index.html'>Головна</a><span class='gap'>/</span></li><li class='breadcrumbs-about'><em>Доставка</em></li></ul></div></div></div></div>");
$(".menu-breadcrumbs").insertAfter("header");


//Контент для страницы  Доставка

$(".content_main").append("<div class='delivery-info-pages'><div class='container'><div class='row'><div class='col-md-12'><p>&nbsp;</p><div><div class='b-content'><strong>Вартість доставки:&nbsp</strong></div><div class='b-content'>&nbsp;</div></div><div><div class='b-content'><p>- &nbsp;<span>Кур'єрська доставка по Києву &nbsp; - &nbsp; </span><strong> 40 грн.</strong></p><p>- &nbsp<span>Доставка на відділення Нової Пошти -<strong> відповідно &nbsp;до тарифів Нової Пошти;</strong>&nbsp;</span></p><p>- &nbsp<span><strong>Безкоштовна доставка</strong>&nbsp;при замовленні<strong> - &nbsp;від 700 грн. </strong></span></p><div class='b-content'>&nbsp</div><p><strong>Терміни доставки:&nbsp;</strong></p><div class='b-content'>&nbsp</div><p>- &nbsp<span>Кур'єрська доставка по Києву &nbsp; - &nbsp; </span><strong>2-4 дні</strong>;&nbsp;</p></div><div><p>- &nbsp;<span>Доставка на відділення Нової Пошти - <strong>2-3 дні</strong>;&nbsp;</span></p><p><span>&nbsp</span></p><p>&nbsp</p><p>&nbsp</p></div></div><p>&nbsp</p><img src='../../images/shipping-concept.png'  alt='delivery'></div></div></div></div>");
